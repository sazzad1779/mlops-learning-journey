...
3. [Staging in Git](#Staging-in-Git)
3. [Committing in Git](#Committing-in-Git)
3. [Git Reset](#git-reset)
3. [Removing Files in Git](#Removing-Files-in-Git)
3. [Branches in Git](#Branches-in-Git)
4. [Pushing to Remote in Git](#Pushing-to-Remote-in-Git)
5. [Pulling from Remote in Git](#Pulling-from-Remote-in-Git)
6. [Fetching Changes in Git](#Fetching-Changes-Git)
7. [Merging and Rebasing in Git](#Merging-and-Rebasing-in-Git)
8. [Stashing in Git](#Stashing-in-Git)
9. [Viewing Logs in Git](#Viewing-Logs-in-Git)
10. [Merging and Rebasing](#merging-and-rebasing)
